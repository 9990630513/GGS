          ...
          <div class="col-xs-12 col-sm-7 col-md-6">
            <div class="col-xs-12 col-sm-6 col-md-5">
              <ul class="footer_contact">
                <li>Contact Us</li>
                <li>Address</li>
                <li><a href="#">A-12, Sector-132,<br> Expressway,  Noida - 201304.</a></li>
                <li>Mobile</li>
                <li><a href="tel:+91-9711000498, 560, 625, 626">+91-9711000498 / 560 / 625 / 626</a></li>
                <li>Email</li>
                <li><a href="mailto:principal@genesisgs.edu.in">principal@genesisgs.edu.in</a></li>
              </ul>
            </div>
    ...
    <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12">
            <p>© Copyright 2010, all rights reserved with Genesis Global School </p> 
  ...
  <script>
      (function() {
        [].slice.call( document.querySelectorAll( 'select.abt_al_select' ) ).forEach( function(el) {  
          new SelectFx(el);
        } );
      })();
    </script>
    ...
    jQuery(document).ready(function() {
        ...
        if(winWidth < 768){
          ...
          $('.tab-content a').click(function(event) {
            ...
            createClassFromId = clickedId.split("#");
            $(clickedId).toggle();
             //$(clickedId).css("height","auto");
          }); 
        }
    });
  </script>
