                  ...
                  <div class="container">
                    <div class="col-xs-12 col-sm-11 col-md-11 col-md-offset-1">
                       <h2 class="h3_trigger ggs_about_team" id="5">SCHOLARS RESIDENCES</h2>
                        <h3><span class="h3_trigger ggs_about_team" id="5">Residential School</span>
                          <!-- <select class="cs-select our-team-select" onchange="javascript:handleSelect(this)">
                            <option value="residential-school">5 Day Residence</option>
                            <option value="daily-routine">7 Day Residence</option>
                          </select> -->
                        </h3>
                    </div>
                  </div>
