<?php include("inc/header-school-life.php"); ?>
 <!-- Adventure Sports & The Outdoors Section -->
            ...
            <div class="container-fluid">
                  <div class="container">
                    <div class="col-xs-12 col-sm-11 col-md-11 col-md-offset-1">
                      ...
                      <h3 class="h3_trigger ggs_about_team" id="4">The Spirit of Adventure •
                  ...
                  <div class="container about_slider_bg academics_the_curriculum wide_range_sports">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-9 career_counselling">
                          <b>Adventure Sports and the Outdoors</b>
                            <p>
                              Interaction with nature and wildlife is important in a scholar’s understanding of the delicate balance 
                              and relationship that we share with our environment. Exposure to ecology and environment in the 
                              formative years, builds an understanding of the world around us. This leads to respect and 
                              understanding of the roles of everybody in the protection of the environment. During outdoor 
                              excursions, scholars learn to develop the dynamics of group interaction, interdependence and team 
                              spirit – essential skills for their adult life. Each scholar is encouraged to participate in outdoor 
                              activities and adventure sports. The school organises regular excursions to locations all over the 
                              country, which provide exciting opportunities and experiences. 
                            </p>  
                            <p>
                              These include:   
                            </p>
                            <ul>
                               ...
                               <li>Visits to Nature Parks and Wildlife Sanctuaries</li>
                               <li>River Rafting</li>
                               <li>Rock Climbing</li>
                             </ul>   
                             <b>Trekking</b>
                             <p>
                               Adventure has always been an integral part of our lives. Every individual craves to do something 
                                outside the box and test his limits. Following the same norm, Genesis Global School conducts many 
                                adventure trips and trekking expedition which enable the scholars to test their limits and reveal their 
                                greatest potential. We have successfully hosted a trek to Tali Glacier wherein a batch of nine 
                                students conquered the summit of Tali. The trek helped the students to acknowledge their strengths 
                                and weaknesses. The 12 days in wilderness helped the scholars to respect the nature and co-exist 
                                with it. The students learnt to appreciate the natural beauty around them but most importantly, 
                                they learnt to accept themselves as beautiful and responsible human beings. Such expeditions offer 
                                a sort of catharsis for every individual and helps them to ignite the potential in them.  
                             </p>
                        </div>
                  </div>
              </div>
    ...
    <!-- END Adventure Sports & The Outdoors -->
